...
const TUTORIALES: { title: string; video: string }[] = [
  { title: "Cómo agregar un producto", video: "COMO_CREAR_UN_PRODUCTO.mp4" },
  { title: "Cómo ver el listado de productos", video: "COMO_VER_LISTADO_DE_PRODUCTOS.mp4" },
  { title: "Cómo buscar movimientos de stock por producto", video: "COMO_BUSCAR_MOVIMIENTOS_DE_STOCK_POR_PRODUCTO.mp4" },
  { title: "Cómo crear un despacho", video: "COMO_CREAR_UN _DESPACHO.mp4" },
  { title: "Cómo hacer seguimiento de despachos", video: "COMO_BUSCAR_DESPACHOS.mp4" },
  { title: "Cómo gestionar centros de costos", video: "COMO_CREAR_UN_CLIENTE.mp4" },
  { title: "Cómo recibir de proveedores", video: "COMO_REGISTRAR_LA_RECEPCION_DE_MERCADERIA.mp4" },
  { title: "Cómo ver recepciones registradas", video: "COMO_BUSCAR_RECEPCIONES_REGISTRADAS.mp4" },
  { title: "Cómo gestionar proveedores", video: "COMO_GESTIONAR_PROVEEDORES.mp4" },
  { title: "Cómo registrar ingreso de producción", video: "COMO_REGISTRAR_PRODUCCIONES.mp4" },
  { title: "Cómo ver registros de producción", video: "COMO_BUSCAR_PRODUCCIONES_REGISTRADAS.mp4" },
  { title: "Cómo gestionar operarios", video: "COMO_GESTIONAR_OPERARIOS.mp4" },
  { title: "Cómo crear una nota de crédito", video: "COMO_REGISTAR_UNA_NOTA_DE_CREDITO.mp4" },
  { title: "Cómo hacer seguimiento de notas de crédito", video: "COMO_VER_NOTAS_DE_CREDITOS_REGISTRADAS.mp4" },
  { title: "Cómo gestionar choferes", video: "COMO_GESTIONAR_CHOFERES.mp4" },
  { title: "Cómo registrar consumo interno", video: "COMO_REGISTRAR_UN_CONSUMO_INTERNO.mp4" },
  { title: "Cómo ver registros de consumos internos", video: "COMO_VER_REGISTROS_DE_CONSUMOS_INTERNOS.mp4" },
  { title: "Cómo ver récords de producción", video: "COMO_VER_RECORDS_DE_PRODUCTOS.mp4" },
  { title: "Cómo guardar cambios de productos", video: "COMO_REGISTRAR_CAMBIOS_DE_PRODUCTOS .mp4" },
  { title: "Cómo hacer seguimiento de cambios de productos", video: "COMO_VER_REGISTROS_DE_CAMBIOS_DE_PRODUCTOS.mp4" },
];
