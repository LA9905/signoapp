  ...
  return (
    <>
      <style>{`
        ...
        /* ─── Modo claro ─── */
        body[data-theme="light"] .opr-input {
          background: #FFFFFF;
          border: 1px solid rgba(15,23,42,0.12);
          color: #0F172A;
        }
        body[data-theme="light"] .opr-input::placeholder { color: rgba(15,23,42,0.3); }
        body[data-theme="light"] .opr-input:focus {
          border-color: rgba(99,102,241,0.6);
          box-shadow: 0 0 0 3px rgba(99,102,241,0.1);
        }
        body[data-theme="light"] .opr-select {
          background: #FFFFFF;
          border: 1px solid rgba(15,23,42,0.12);
          color: rgba(15,23,42,0.8);
        }
        body[data-theme="light"] .opr-select option {
          background: #FFFFFF;
          color: #0F172A;
        }
        body[data-theme="light"] .opr-icon-btn-cancel {
          background: rgba(15,23,42,0.04);
          border-color: rgba(15,23,42,0.12);
          color: rgba(15,23,42,0.55);
        }
        body[data-theme="light"] .opr-icon-btn-cancel:hover {
          background: rgba(15,23,42,0.08);
          color: #0F172A;
        }
        body[data-theme="light"] .opr-btn-new {
          color: #4338CA;
        }
        body[data-theme="light"] .opr-btn-save-new {
          color: #059669;
        }
        body[data-theme="light"] .opr-btn-cancel-new {
          background: rgba(15,23,42,0.04);
          border-color: rgba(15,23,42,0.12);
          color: rgba(15,23,42,0.55);
        }
        body[data-theme="light"] .opr-btn-cancel-new:hover {
          background: rgba(15,23,42,0.08);
          color: #0F172A;
        }
        body[data-theme="light"] .opr-edit-input {
          background: #FFFFFF;
          color: #0F172A;
        }
        body[data-theme="light"] .opr-edit-input::placeholder { color: rgba(15,23,42,0.3); }
        body[data-theme="light"] .opr-search-icon {
          color: rgba(15,23,42,0.3);
        }
        body[data-theme="light"] .opr-select-arrow {
