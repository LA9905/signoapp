      ...
      <div className="ls-container">
        ...
        <div className="ls-fade-in" style={{ marginBottom: 28 }}>
          ...
          <p style={{ fontSize: 13, color: "rgba(255,255,255,0.3)", margin: 0 }}>
            Gestión de choferes del sistema
          </p>
        </div>
        ...
        <div className="ls-glass ls-fade-in" style={{ padding: "20px 24px", marginBottom: 16 }}>
          ...
          <div style={{ marginBottom: 20 }}>
            <label className="ls-field-label">Buscar chofer</label>
            <input
              type="text"
          ...
          <div style={{ marginBottom: 24 }}>
            <label className="ls-field-label">Agregar nuevo chofer</label>
          ...
          <div style={{ display: "flex", alignItems: "center", marginBottom: 12 }}>
            ...
            <span className="ls-count">{filteredDrivers.length}</span>
          </div>

          {/* Lista */}
          {filteredDrivers.length === 0 ? (
            <div className="ls-empty">
              {search ? `Sin resultados para "${search}"` : "No hay choferes registrados aún."}
            </div>
          ) : (
                ...
                return (
                  ...
                  >
                    <div style={{ flex: 1, minWidth: 0 }}>
                      {!isEditing ? (
                        <span className="ls-item-name">{driver.name}</span>
                      ) : (
                        <input
                          value={tmpName}
